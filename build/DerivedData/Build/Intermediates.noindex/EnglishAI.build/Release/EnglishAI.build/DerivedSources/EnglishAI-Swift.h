...
#ifndef ENGLISHAI_SWIFT_H
#define ENGLISHAI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="EnglishAI",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC9EnglishAI11AppDelegate")
...
@class NSWindow;
@class NSCoder;
SWIFT_CLASS("_TtC9EnglishAI23RecordsWindowController")
@interface RecordsWindowController : NSWindowController
